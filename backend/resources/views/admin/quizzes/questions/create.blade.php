...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body">
        <h5 class="mb-2">Adding Question to: <strong>{{ $quiz->title }}</strong></h5>
    ...
    <div class="col-md-10 mx-auto">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-0 py-3">
                <h5 class="mb-0 fw-bold">Add New Question</h5>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="btn-group w-100" role="group">
                            <input type="radio" class="btn-check" name="question_type" id="type_single" value="single_correct" 
                                   {{ old('question_type', 'single_correct') == 'single_correct' ? 'checked' : '' }} required>
                            ...
                            <input type="radio" class="btn-check" name="question_type" id="type_multiple" value="multiple_correct"
                                   {{ old('question_type') == 'multiple_correct' ? 'checked' : '' }}>
                            ...
                            <input type="radio" class="btn-check" name="question_type" id="type_tf" value="true_false"
                                   {{ old('question_type') == 'true_false' ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('question_text') is-invalid @enderror" 
                                  name="question_text" rows="3" required>{{ old('question_text') }}</textarea>
                        @error('question_text')
                        ...
                        <div class="d-flex gap-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="correct_answers[]" value="A" id="correct_a"
                                       {{ is_array(old('correct_answers')) && in_array('A', old('correct_answers')) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="correct_answers[]" value="B" id="correct_b"
                                       {{ is_array(old('correct_answers')) && in_array('B', old('correct_answers')) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="correct_answers[]" value="C" id="correct_c"
                                       {{ is_array(old('correct_answers')) && in_array('C', old('correct_answers')) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="correct_answers[]" value="D" id="correct_d"
                                       {{ is_array(old('correct_answers')) && in_array('D', old('correct_answers')) ? 'checked' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('marks') is-invalid @enderror" 
                                   name="marks" value="{{ old('marks', 1) }}" min="0" required>
                            @error('marks')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('negative_marks') is-invalid @enderror" 
                                   name="negative_marks" value="{{ old('negative_marks', 0) }}" min="0">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('explanation') is-invalid @enderror" 
                                  name="explanation" rows="3" placeholder="Explain the correct answer...">{{ old('explanation') }}</textarea>
                        @error('explanation')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Save & Back to List
                            </button>
                        </div>
                    </div>
                </div>
